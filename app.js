      ...
      <div class="dashboard-main">
        <div class="dashboard-title-wrap">
          ...
          <div>
            ...
            <h2>Editor Cubari direto no GitHub Pages</h2>
          </div>
        </div>

        <div class="dashboard-status-row">
          ${saved ? `<span class="status-pill"><span class="status-dot"></span>${escapeHtml(saved.owner)}/${escapeHtml(saved.repo)}</span>` : ''}
          ${hasToken ? '<span class="mini-stat"><strong>Token salvo</strong></span>' : '<span class="mini-stat"><strong>Token não salvo</strong></span>'}
        </div>
      </div>
